 ...
 * @details Only allowed in PROGRAMMING_SESSION.
 ...
 *          Rejects frames with even length (malformed) or multiple DIDs.
 *          Requires temp <= 10 (checked in dispatcher).
 * @param  length : payload length from frame[0].
